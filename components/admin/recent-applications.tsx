// app/components/admin/recent-applications.tsx
"use client"
    ...
    const fetchRecentApplications = async () => {
      try {
        ...
        if (data.success) {
          ...
          setError(data.message || 'Failed to load recent applications')
        }
      } catch (error) {
        setError('An error occurred while fetching recent applications')
